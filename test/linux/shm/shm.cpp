...
int main(int argc, char *argv[]){
    ...
    // 0x1605 : Target position, Target velocity, Target Torque, Max.Torque, Control Word, Mode of Operation
                // Postion, Velocity, Torque
    uint16 map_1c13[5] = {0x0004, 0x1a00, 0x1a11, 0x1a13, 0x1a1e};
    // 0x1a00 : Position Actual Value, Digital Inputs, Status Word // Position
    // 0x1a11 : Velocity Actual Value
    // 0x1a13 : Torque Actual Value
    // 0x1a1e : Auxiliary Position Actual Value
    CEtherCat ethc;
    ...
    printf("slidnf\n");
    //ethc.mappingpdo1(map_1c12,map_1c13);
    ...
    //rt_task_create(&my_task,"my_task",0,99,T_JOINABLE);
    //rt_task_start(&my_task,&CEtherCat::operatecyclictask_help,argv[1]);
